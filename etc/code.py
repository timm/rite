#!/usr/bin/env python3
"""Run from a WORKDIR root. Draft coding grid (Table-4 style) for the reading
...
import sys
sys.path.insert(0, os.getcwd())  # workdir flags.py
...
recent  = code("lit/read.tsv", "lit/recent/coding.tsv")
classic = code("lit/read-classics.tsv",
