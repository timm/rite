#!/usr/bin/env python3
"""Run from a WORKDIR root. Fetch open-access PDFs for
both reading lists, into lit/recent/pdf/ and
lit/classics/pdf/. Reports how
...
a = grab("lit/read.tsv", "lit/recent/pdf")
b = grab("lit/read-classics.tsv", "lit/classics/pdf")
